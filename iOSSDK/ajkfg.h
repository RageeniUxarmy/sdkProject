 ...
 */
+ (nullable ajkfg *)HUDForView:(UIView *)view;
 ...
 */
@property (assign, nonatomic) NSTimeInterval mnjk;
 ...
 * Progress (0.0 to 1.0)
 */
@property (nonatomic, assign) float xProg;

/**
 * Indicator progress color.
 * Defaults to white [UIColor whiteColor].
 */
@property (nonatomic, strong) UIColor *progr;
 ...
 */
@property (nonatomic, assign, getter = isAnnular) BOOL dasf;
 ...
 */
@interface MASG : UIView

/**
 * Progress (0.0 to 1.0)
 */
@property (nonatomic, assign) float sdf;

/**
 * Bar border line color.
 * Defaults to white [UIColor whiteColor].
 */
@property (nonatomic, strong) UIColor *lsce;

/**
 * Bar background color.
 * Defaults to clear [UIColor clearColor];
 */
@property (nonatomic, strong) UIColor *eeesa;
 ...
 */
@property (nonatomic) MBProgressHUDBackgroundStyle sety;

/**
 * The background color or the blur tint color.
 * @note Due to iOS 7 not supporting UIVisualEffectView, the blur effect differs slightly between iOS 7 and later versions.
 */
@property (nonatomic, strong) UIColor *olcs;

@end

@interface ajkfg (Deprecated)
